...
| **Product** | `docs/PRD.md` (intent, outcomes, non-goals), `docs/specification.md` (stories), `docs/SCENARIOS.md` (Given/When/Then, mapped to the Minitest tests) |
...
creating**, not this repository's own agent file. Its long-memory pointer is
a blank you fill in with wherever your project's notes will live.
